...
{
    public $id = 1;
    public $name = 'TreinaTEK';
    public $site = 'https://ead.teknisa.com/';
    public $description = "Lorem Ipsum is simply dummy text of the printi
    ng and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an 
